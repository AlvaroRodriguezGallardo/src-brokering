...
First of all, let $F:\Omega \subset \mathbb{R^n} \to \mathbb{R^m}$ a vectorial field, and $g(x)=(g(x_1),...,g(x_k))<=0 \forall x \in \mathbb{R^n}$, i.e., $g(x_i)<=0 \text{ } \forall i \in {1,...,k}$.
